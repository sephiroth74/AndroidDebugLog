...
object Constants {
    ...
    object SimpleLog {
        const val CLASS_NAME = "it/sephiroth/android/library/asm/commons/logging/SimpleLog"
        ...
        // replacements
        private val LOG_TAG = ClassMethodVo(CLASS_NAME, "log", "(Ljava/lang/String;[Ljava/lang/Object;ILjava/lang/String;)V", Opcodes.INVOKESTATIC)
        private val LOG_THROWABLE_TAG = ClassMethodVo(CLASS_NAME, "log", "(Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;ILjava/lang/String;)V", Opcodes.INVOKESTATIC)
        private val LOG_THROWABLE_ONLY_TAG = ClassMethodVo(CLASS_NAME, "log", "(Ljava/lang/Throwable;ILjava/lang/String;)V", Opcodes.INVOKESTATIC)
